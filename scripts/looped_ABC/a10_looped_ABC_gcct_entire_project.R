...
setwd("C:/git/CAMP_10yr_proj/scripts/looped_ABC/")  # Change depending on machine
rm(list=ls())
library(EasyABC)
library(MASS)
set.seed(0)
...
source("a10_looped_ABC_import.R")                          # Get all inputs
source("a10_looped_ABC_process_inputs.R")                  # Process inputs (i.e. conduct regressions, etc.)
source("a10_looped_ABC_make_behav_inputs_all_2007.R")      # override 2009-2017 numbers with 2007 for both calibration and no-behavior-change models
source("a10_looped_ABC_process_dx_for_calib.R")            # create total (pseudo-age-specific) diagnosis numbers for step 1 of the calibration 
source("a10_looped_ABC_ABC_gc.R")
source("a10_looped_ABC_ABC_ct.R")
...
source("a10_looped_ABC_ct_calibration_pt1.R")              # CT calib pt 1 (starting with non-age-specific dx)
...
source("a10_looped_ABC_ct_calibration_pt1_sim.R")          # simulate from CT calib pt 1 to get starting age-specific dx

source("a10_looped_ABC_ct_calibration_pt2.R")              # CT calib pt 2 (starting with age-specific dx)
...
source("a10_looped_ABC_ct_calibration_pt2_sim.R")          # CT calib pt 3 (starting with non-age-specific dx)

source("a10_looped_ABC_ct_calibration_pt3.R")              # CT calib pt 3 (starting with age-specific dx)
...
source("a10_looped_ABC_ct_calibration_pt3_sim.R")          # CT calib pt 3 (starting with non-age-specific dx)
