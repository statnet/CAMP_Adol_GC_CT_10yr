...
load("../../output/looped_ABC/a10_ct_nbc.rda")
load("../../output/looped_ABC/a10_ct_obs.rda")
load("../../output/looped_ABC/a10_gc_nbc.rda")
load("../../output/looped_ABC/a10_gc_obs.rda")
...
bmp("../../output/looped_ABC/predicted.bmp", width=920, height=700)
...
bmp("../../output/looped_ABC/a10_race.bmp", width=800, height=800)
plotoffset = 0.07
par(mfrow=c(2,1))
...
bmp("../../output/looped_ABC/a10_age.bmp", width=500, height=800)
plotoffset = 0.07
par(mfrow=c(2,1))
...
save.image("../../output/looped_ABC/a10_gcct.fullresults.rda.")


#####################################
#  Boneyard

#bmp("../../output/looped_ABC/costs.gc.bmp")
