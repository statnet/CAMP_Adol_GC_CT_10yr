...
minrun <- which(a10_calib_gc_pt1$stats==min(a10_calib_gc_pt1$stats))
part_prev_ratio_gc_f <- as.vector(a10_calib_gc_pt1$param[minrun,1:3])
part_prev_ratio_gc_m <- as.vector(a10_calib_gc_pt1$param[minrun,4:6])

a10_calib_gc_pt1_sim <- a10(n_f = n_f, 
                            n_m = n_m,
...
save(a10_calib_gc_pt1_sim, file='../../output/looped_ABC/a10_calib_gc_pt1_sim.rda')
