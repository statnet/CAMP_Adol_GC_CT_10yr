...
a10_ct_obs <- a10(n_f = n_f, 
                n_m = n_m,
                prop_eversex_f = pred_eversex_f_dyn,
                prop_eversex_m = pred_eversex_m_dyn,
                condom_use_f = pred_condom_f_dyn,
                condom_use_m = pred_condom_m_dyn,
                mean_new_part_f = pred_mnppy_f_dyn,
                mean_new_part_m = pred_mnppy_m_dyn,
...
save(a10_ct_obs, file='../../output/looped_ABC/a10_ct_obs.rda')
