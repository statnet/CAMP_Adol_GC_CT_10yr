...
Oh happy day! Yesterday I finally figured out the problem - the output I was producing ws diagnoses in school ,and I was comparing it to the initial total diagnoses. So of course one would need a growing epidemic for those two numbers to match, making all subseuqent years bigger.  I re-wrote the code  track borth diag_insch and diag_total, as well as both inc_insch and inc_total, and to then properly compare diag_total to the initial diagnoses.  Works!!!!  Interestingly, my earlier idea still holds about needing to do two rounds to get the age distribution correct  - the first version is close, and then the second vesion is on.  Techinically it's off by a few dozen diagnoses, but given the 10s of 1000s total, this is trivial.  Yay!
...
Looks like I skipped an update sometime in the last week, where I updated the excel version of the 10 year tool to accurately capture all the edits I had made to the actual (R-based) 10-year tool, in terms of outpus in and out of school, and proper calibration thereof.
