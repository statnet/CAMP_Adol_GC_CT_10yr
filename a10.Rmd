...
And now I just updated local github and delved in here, comparing the R and escel versions. I confirmed that the nbc scenario was the same in both for the first 3 years of results.  Then I put in the behavior change around eversex only.  The numbers ever having sex go down, but the predicted diagnoses go up.  So therein lies a problem! I immediately saw two possible issues:

- as the number ever having sex goes down ove time, the prevalence goes up because it is calcuated on the new population size
- this creates especially weird issues for 18-yo, where the population size is dramatically smaller than the 17 yo from the year before, due to aing out.
