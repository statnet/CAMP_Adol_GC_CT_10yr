...
- import diagnoses from every year, not just from 2007? But the model only uses the first year and then models all the others from there.
- are there any other inputs that need to change by year????
- revisit decision on what to do about pops that are < HS enrollment
