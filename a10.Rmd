...
Spent asome hours with the CDC surveillance reports.  Very good news: they publish numbers for sex x age x race.  Downside: huge amounts of missing by race; they don't impute (or at least they did up until 2009).  So we will need to adjust all of them for that. Up next!
...
- get race mixing
- get tot 13-18 pop (not just in school)  # MOSTLY DONE (AWAITING CENSUS BUREAU)
- consider revisiting coital acts by single year age groups # NO
