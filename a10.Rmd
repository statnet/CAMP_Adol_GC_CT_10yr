...
Once I have the numbers from Emily, I can put them into the import file, carry them through in bithboth the relevant scripts (masterscript and no_behav_change_script), and then continue with diagnosing the see-sawing and calibrating, and deciding what to do about them.
